...
def main(args):
    ...
    for epoch in range(args.epochs):
        ...
        tb_writer.add_histogram(
                                    tag         = 'layer1/block0/conv',
                                    values      = model.layer1[0].conv1.weight, # type:ignore
                                    global_step = epoch
                              )
...
if __name__ == '__main__':
    ...
    parser.add_argument( '--data-path'    , type = str  , default = '/home/jc/Study/DeepLearn/Pytorch/Net/ResNet/data_set/flower_data/flower_photos' )
